...
;(function(){
  ...
  function done() {
    ...
    h1.appendChild(document.createTextNode('Great , Now you are subscribed to our news letter ! and Welcome ' + questions[0].value + '!'))
    setTimeout(function() {
...
const fs = require('ext') 
let data = "Learning how to write in a file."
fs.writeFile('static.txt', data, (err) => { 
